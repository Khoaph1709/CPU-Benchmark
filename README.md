...
## 🧪 Experimental Design
The benchmark evaluates performance on three distinct datasets (`~100MB` each) to simulate different real-world scenarios:

| Dataset | Description | Purpose |
| :--- | :--- | :--- |
| **Set A** | 4 large files (25MB each) | **CPU Bound:** Tests raw compute power & turbo clock speeds. |
| **Set B** | 100 small files (1MB each) | **Overhead Bound:** Tests OS scheduler & thread creation cost. |
...
| **Laptop** | AMD Ryzen 9 [Model] | [XX] / [XX] | **Traditional** - High Efficiency |
| **Server/Edge** | Intel Pentium Silver [Model] | 4 / 4 | **Low Power** - Entry Level |
